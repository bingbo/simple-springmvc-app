...
public class AutowiredAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
    ...
    public AutowiredAnnotationBeanPostProcessor() {
        this.autowiredAnnotationTypes.add(MyService.class);
        try {
            this.autowiredAnnotationTypes.add((Class<? extends Annotation>)
                    ClassUtils
                            .forName("javax.inject.Inject",
                                    com.ibingbo.beanpostprocessor.AutowiredAnnotationBeanPostProcessor.class
                                            .getClassLoader()));
            ...
            ReflectionUtils.doWithLocalFields(targetClass, new ReflectionUtils.FieldCallback() {
                public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                    ...
                    if (ann != null) {
                        ...
                        boolean required = determineRequiredStatus(ann);
                        currElements
                                .add(new com.ibingbo.beanpostprocessor
                                ...
                                if (beanFactory.containsBean(autowiredBeanName)) {
                                    if (beanFactory.isTypeMatch(autowiredBeanName, field.getType())) {
                                        this.cachedFieldValue =
                                                new com.ibingbo.beanpostprocessor
